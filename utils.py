...
def bin_spatial(img, color_space = 'RGB', size=(32, 32)):
    feature_image = color_conversion(img, color_space)
...
def extract_features(images, cspace='RGB', spatial_size=(32, 32),
    ...
    for file in tqdm(images):
        ...
        file_features = single_img_features(image, cspace, spatial_size, hist_bins,
                                            orient, pix_per_cell, cell_per_block,
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    ctrans_tosearch = color_conversion(img_tosearch, cspace='YCrCb')
    if scale != 1:
